/**
 * Tests for the NEW belief tools on the LOCAL MCP door
 ...
 * pinned behaviourally in tests/unit/api/), and
 ...
 * rah_recompute_node_belief describe and its stub branch — the recompute
 * surface is dead on both doors (the proxy's display-belief surface is
 * pinned in stdio-server-display-belief-surface.test.ts).
 *
